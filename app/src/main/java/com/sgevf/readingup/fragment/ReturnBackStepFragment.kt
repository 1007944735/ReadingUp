...
import com.sgevf.readingup.databinding.FragmentStepReturnBackBinding
import com.sgevf.readingup.viewmodel.TaskStepCreateViewModel

class ReturnBackStepFragment: Fragment() {

    private lateinit var mViewModel: TaskStepCreateViewModel

    private lateinit var mDataBinding: FragmentStepReturnBackBinding
    override fun onCreateView(
        ...
        mDataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_step_return_back, container, false)
